...
namespace TestEngine.Services
{
    ...
    public class TestSaveGameService
    {
        ...
        {
            GameSession gameSession = SaveGameService.LoadLastSaveOrCreateNew(@".\TestFiles\SavedGames\Game_0_1_000.soscsrpg");
            ...
            Assert.IsNull(gameSession.CurrentPlayer.CurrentWeapon);
            Assert.AreEqual(2001, gameSession.CurrentPlayer.CurrentConsumable.ItemTypeId);
        }
    }
}
