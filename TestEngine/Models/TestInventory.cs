...
namespace TestEngine.Models
{
    ...
    public class TestInventory
    {
        ...
        public void Test_RemoveItemQuantities()
        {
            ...
            Inventory inventory2 = inventory1.RemoveItems(new List<ItemQuantity> { new ItemQuantity(1002, 2) });
            Assert.AreEqual(1, inventory2.Items.Count(i => i.ItemTypeId == 1001));
            Assert.AreEqual(2, inventory2.Items.Count(i => i.ItemTypeId == 1002));
        ...
        public void Test_RemoveItemQuantities_RemoveTooMany()
        {
            ...
            Inventory inventory2 = inventory1.RemoveItems(new List<ItemQuantity> { new ItemQuantity(1002, 999) });
        }
    }
}
