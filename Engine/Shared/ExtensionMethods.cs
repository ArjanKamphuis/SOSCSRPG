...
namespace Engine.Shared
{
    public static class ExtensionMethods
    {
        ...
        public static string AttributeAsString(this XmlNode node, string attributeName)
        {
            ...
            return attribute == null ? throw new ArgumentException($"The attribute '{attributeName}' does not exist") : attribute.Value;
        }
        ...
        {
            return entity.Attributes.Single(pa => pa.Key.Equals(attributeKey, StringComparison.OrdinalIgnoreCase));
        }
    }
}
