...
namespace Engine.Factories
{
    internal static class QuestFactory
    {
        ...
        static QuestFactory()
        {
            List<ItemQuantity> itemsToComplete = new List<ItemQuantity>() { new ItemQuantity(9001, 5) };
            List<ItemQuantity> rewardItems = new List<ItemQuantity>() { new ItemQuantity(1002, 1) };
